...
const ValueCard = ({ icon, title, description, ...others }: ValueCardProps) => {
  return (
    ...
    <div
      className="card-hover flex flex-col gap-5 rounded-2xl border-2 bg-neutral-200 bg-gradient-to-b p-8 dark:border-neutral-700 dark:from-neutral-800 dark:to-neutral-900"
      {...others}
    >

...
const TestimonialCard = ({
  ...
  return (
    <div className="mx-4 rounded-2xl bg-gradient-to-br p-0.5 dark:from-purple-500 dark:via-pink-500 dark:to-yellow-500 w-96 hover:scale-105 duration-150 transition">

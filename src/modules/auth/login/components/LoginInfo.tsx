  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center gap-16 bg-gradient-to-b from-neutral-200 to-neutral-100 px-8 dark:from-neutral-800 dark:to-neutral-900 lg:p-16">
      <div className="flex flex-col gap-2 text-center">
        ...
        >
          Access your account to manage your content and track your progress.
      ...
      <div className="relative">
        ...
        <Image
          ...
          height={200}
          alt="login"
          className="absolute -right-12 bottom-3 hidden translate-y-1/2 rounded-md border-2 border-neutral-500 md:block"
          data-aos="fade-left"
          data-aos-delay="600"
          data-aos-anchor="#login"
        />

    ...
    <div className="rounded-2xl bg-gradient-to-br p-0.5 dark:from-purple-500 dark:via-pink-500 dark:to-yellow-500">
      <div className="space-y-5 rounded-xl bg-neutral-200 bg-gradient-to-b p-8 dark:from-neutral-800 dark:to-neutral-900">
        ...
        <div className="flex gap-4">
          <input
            type="text"
            className="w-full rounded-xl bg-neutral-300 p-3 dark:bg-neutral-600 outline-none"
            placeholder="Enter your email"
          />
          <button className="rounded-xl bg-neutral-300 p-3 dark:bg-neutral-600">Subscribe</button>
        </div>
      </div>
    </div>
  );
